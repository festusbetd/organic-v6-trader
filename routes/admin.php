...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'transaction', 'as' => 'transaction.' ,'middleware'=>['module:business_section']], function () {
            ...
            Route::get('mpesa_list', 'TransactionController@mpesa_list')->name('mpesa_list');
        });
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
            ...
            Route::get('email-module', 'EmailModuleController@email_index')->name('email-module');
            Route::post('email-module-update/{email_module}', 'EmailModuleController@email_update')->name('email-module-update');
        });
        //order management
