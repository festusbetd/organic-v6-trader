...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::group(['middleware'=>['customer']], function () {
        ...
        //added
        Route::get('checkout_details_pick', 'WebController@checkout_details_pick')->name('checkout_details_pick');
        ...
        Route::post('order_collection_date', 'WebController@order_collection_date')->name('order_collection_date');
        Route::post('order_collection_time', 'WebController@order_collection_time')->name('order_collection_time');
    });
    ...
    Route::get('chat-for-product', 'WebController@chat_for_product')->name('chat-for-product');
      ...
      Route::get('register_seller', 'WebController@registerSeller')->name('register_seller');
...
Route::post('mpesa-pay', 'MpesaPaymentController@index');
...
//Mpesa pay
Route::match(['get', 'post'], '/return-mpesa-pay', 'MpesaPayController@return_mpesa_pay')->name('return_mpesa_pay');
