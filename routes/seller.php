...
Route::group(['namespace' => 'Seller', 'prefix' => 'seller', 'as' => 'seller.'], function () {
    ...
    Route::group(['middleware' => ['seller']], function () {
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.'], function () {
            ...
            Route::post('unit_pricing_update', 'ProductController@unit_pricing_update')->name('unit_pricing_update');
            Route::get('list', 'ProductController@list')->name('list');
                       //added for users
            Route::get('users', 'ProductController@users')->name('users');
            Route::get('add-new-user', 'ProductController@add_new_user')->name('add-new-user');
        ...
        Route::group(['prefix' => 'user', 'as' => 'user.'], function () {
            ...
            Route::get('users', 'ProductController@users')->name('users');
            Route::get('add-new-user', 'ProductController@add_new_user')->name('add-new-user');
            Route::post('createUser', 'ProductController@createUser');
            Route::post('createUser', 'ProductController@createUser')->name('createUser');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'shipping-method', 'as' => 'shipping-method.'], function () {
                ...
                Route::post('unit_pricing_update', 'ShippingMethodController@unit_pricing_update')->name('unit_pricing_update');
            });
