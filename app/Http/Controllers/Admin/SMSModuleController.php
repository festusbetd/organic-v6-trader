...
class SMSModuleController extends Controller
{
    ...
    public function sms_update(Request $request, $module)
    {
        ...
        elseif ($module == 'celcom_pending') {
            DB::table('business_settings')->updateOrInsert(['type' => 'celcom_pending'], [
                'type' => 'celcom_pending',
                'value' => json_encode([
                    'status' => $request['status'],
                    'api_key' => $request['api_key'],
        ...
        elseif ($module == 'celcom_confirmation') {
            DB::table('business_settings')->updateOrInsert(['type' => 'celcom_confirmation'], [
                'type' => 'celcom_confirmation',
                'value' => json_encode([
                    'status' => $request['status'],
                    'api_key' => $request['api_key'],
                ]),
        ...
        elseif ($module == 'celcom_processing') {
            DB::table('business_settings')->updateOrInsert(['type' => 'celcom_processing'], [
                'type' => 'celcom_processing',
                'value' => json_encode([
                    'status' => $request['status'],
                    'api_key' => $request['api_key'],
                ]),
        ...
        elseif ($module == 'celcom_order_delivery') {
            DB::table('business_settings')->updateOrInsert(['type' => 'celcom_order_delivery'], [
                'type' => 'celcom_order_delivery',
                'value' => json_encode([
                    'status' => $request['status'],
                    'api_key' => $request['api_key'],
                ]),
        ...
        elseif ($module == 'celcom_delivered') {
            DB::table('business_settings')->updateOrInsert(['type' => 'celcom_delivered'], [
                'type' => 'celcom_delivered',
                'value' => json_encode([
                    'status' => $request['status'],
                    'api_key' => $request['api_key'],
                ]),
        ...
        elseif ($module == 'celcom_failed') {
            DB::table('business_settings')->updateOrInsert(['type' => 'celcom_failed'], [
                'type' => 'celcom_failed',
                'value' => json_encode([
                    'status' => $request['status'],
                    'api_key' => $request['api_key'],
