...
class CustomerController extends Controller
{
    ...
    public function add_new_address(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'zip' => 'required',
            'phone' => 'required',
            'order_collection_date' => 'required',
            'order_collection_time' => 'required',
            'latitude' =>'required',
            'longitude' =>'required',
            'is_billing' => 'required'
        ]);
        ...
        $address = [
            ...
            // 'order_collection_date' => $request->order_collection_date,
            // 'order_collection_time' => $request->order_collection_time,
