                    ...
                    <div class="card-body">
                        <form action="{{route('admin.business-settings.shipping-method.add')}}"
                            ...
                            <div class="form-group">
                                <div class="row justify-content-center">
                                    <div class="col-md-12">
                                        <label for="shop_openings">Shop Openings</label>
                                        <input type="text" name="shop_openings" class="form-control"
                                              >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row justify-content-center">
                                    <div class="col-md-12">
                                        <label for="shop_closed_days">Shop Closed Days</label>
                                        <input type="text" name="shop_closed_days" class="form-control"
                                              >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row justify-content-center">
                                    <div class="col-md-12">
                                        <label for="shop_opening_time">Shop Opening Time</label>
                                        <input type="time" name="shop_opening_time" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row justify-content-center">
                                    <div class="col-md-12">
                                        <label for="shop_closing_time">Shop Closing Time</label>
                                        <input type="time" name="shop_closing_time" class="form-control" >
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <th>{{\App\CPU\translate('open days')}}</th>
                                    <th>{{\App\CPU\translate('closed days')}}</th>
                                    <th>{{\App\CPU\translate('open time')}}</th>
                                    <th>{{\App\CPU\translate('closing time')}}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{$method['duration']}}
                                                   ...
                                                   <td>
                                        {{$method['shop_openings']}}
                                    </td>
                                    <td>
                                        {{$method['shop_closed_days']}}
                                    </td>
                                    <td>
                                        {{$method['shop_opening_time']}}
                                    </td>
                                    <td>
                                        {{$method['shop_closing_time']}}
                                    </td>
                                        <td>
