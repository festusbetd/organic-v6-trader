                ...
                <div class="card-body">
                    <form action="{{route('admin.business-settings.shipping-method.update',[$method['id']])}}"
                        ...
                        <div class="form-group">
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <label for="duration">Shop Openings</label>
                                    <input type="text" name="shop_openings" value="{{$method['shop_openings']}}" class="form-control" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <label for="duration">Shop Closed Days</label>
                                    <input type="text" name="shop_closed_days" value="{{$method['shop_closed_days']}}" class="form-control" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <label for="duration">Shop Opening Time</label>
                                    <input type="time" name="shop_opening_time" value="{{$method['shop_opening_time']}}" class="form-control" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <label for="duration">Shop Closing Time</label>
                                    <input type="time" name="shop_closing_time" value="{{$method['shop_closing_time']}}" class="form-control" placeholder="{{\App\CPU\translate('Ex')}} : {{\App\CPU\translate('4 to 6 days')}}">
                                </div>
                            </div>
                        </div>
