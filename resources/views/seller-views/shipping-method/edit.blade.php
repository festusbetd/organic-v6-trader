                ...
                <div class="card-body">
                    <form action="{{route('seller.business-settings.shipping-method.update',[$method['id']])}}" method="post"
                        ...
                        <div class="form-group">
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <label for="duration">Openings</label>
                                    <input type="text" name="shop_openings" value="{{$method['shop_openings']}}" class="form-control" placeholder="{{\App\CPU\translate('Ex')}} : 4-6 {{\App\CPU\translate('days')}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <label for="duration">closed days</label>
                                    <input type="text" name="shop_closed_days" value="{{$method['shop_closed_days']}}" class="form-control" placeholder="{{\App\CPU\translate('Ex')}} : 4-6 {{\App\CPU\translate('days')}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <label for="duration">Opening Time</label>
                                    <input type="time" name="shop_opening_time" value="{{$method['shop_opening_time']}}" class="form-control" placeholder="{{\App\CPU\translate('Ex')}} : 4-6 {{\App\CPU\translate('days')}}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <label for="duration">Closing Time</label>
                                    <input type="time" name="shop_closing_time" value="{{$method['shop_closing_time']}}" class="form-control" placeholder="{{\App\CPU\translate('Ex')}} : 4-6 {{\App\CPU\translate('days')}}">
                                </div>
                            </div>
                        </div>
