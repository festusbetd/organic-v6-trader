                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}" aria-labelledby="dropdownMenuButton"
                                ...
                                <a class="dropdown-item" href="{{route('customer.auth.login')}}">
                                    <i class="fa fa-sign-in {{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}"></i> Trader {{\App\CPU\translate('sing_in')}}
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{route('customer.auth.register-trader')}}">
                                    <i class="fa fa-user-circle {{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}"></i>Trader {{\App\CPU\translate('sing_up')}}
                                </a>
                            </div>
                        </div>
                    @endif
            ...
            <div class="container">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        ...
                        <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                            <!-- <a class="nav-link" href="{{route('sellers')}}">Farmers</a> -->
                        </li>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                        ...
                                        <a class="dropdown-item" href="{{route('shop.apply')}}">
                                            <b>{{ \App\CPU\translate('Become a')}} Farmer</b>
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="{{route('seller.auth.login')}}">
                                            <b>Farmer  {{ \App\CPU\translate('login')}} </b>
                                        </a>
                                    </div>
                                </div>
                            </li>
