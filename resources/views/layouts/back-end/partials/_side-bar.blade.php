...
<!--                        <li class="nav-item">
                    ...
                    <!--marketing section ends here-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('business_section'))
                            ...
                            <!-- <li class="navbar-vertical-aside-has-menu {{Request::is('admin/transaction/mpesa_list')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.transaction.mpesa_list')}}">
                                    <i class="tio-money nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                 {{\App\CPU\translate('Mpesa Transactions')}}
                                </span>
                                </a>
                            </li> -->
                        @endif
